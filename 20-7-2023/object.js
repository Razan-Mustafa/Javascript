...
const myobj = {
  ...
  age: 25,
  dob: "1998/6/23",
  favoriteFoods: ["Pizza", "fish", "Chocolate"],
  favoriteMovies: ["Inception","The Matrix","Interstellar","Blade Runner","Star Wars"]
};
...
function firstName(people) {
  return people.map(person => person.name.first);
}

const firstNamesArray = firstName(persons);
...
function olderPerson(arr) {
  old = arr.reduce (function (accumulator, person) {
...
olderPerson = olderPerson(persons);
