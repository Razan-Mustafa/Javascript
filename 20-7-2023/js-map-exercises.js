...
function stringItUp(array){
  return array.map (number => String(number))
}
...
*/
arr1 =["john", "JACOB", "jinGleHeimer", "schmidt"]
...
console.log(namesOnly(people1))
//or
function namesOnly(arr){
  return arr.map(function (person){return person.name} )
}
console.log(namesOnly(people1))
/*
 * Exercise 5:  
...
function readyToPutInTheDOM(arr){
  return arr.map (inf =>`<h1> ${inf.name} </h1><h2>${inf.age}</h2>`)
}
document.getElementById("razan").innerHTML =(readyToPutInTheDOM(people));
